...
# @LSST UPS@ &&
# lsst_ups @PRODUCT@ <INSTALL-DIR> [GIT-HASH]
...
lsst_ups() {
    ...
    currentdir=$(pwd)
    git archive --verbose --format=tar --remote=$gitrepo --prefix=ups/ ${githash} ${productname}.build ${productname}.table | tar --extract --verbose --directory $installdir &&
